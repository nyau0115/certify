...
return{
	...
	change_holder: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
			...
			//Step 3 in https://medium.com/coinmonks/demystifying-hyperledger-fabric-1-3-fabric-architecture-a2fdb587f6cb
			//Accumulates and checks the endorsed proposal responses from Endorsing Peers.
		    var proposalResponses = results[0];
		    var proposal = results[1];
		    let isProposalGood = false;
		    if (proposalResponses && proposalResponses[0].response &&
